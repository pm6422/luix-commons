package com.luixtech.springboot2framework.aspect;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.luixtech.springboot2framework.config.LuixProperties;
import com.luixtech.springboot2framework.utils.TraceIdUtils;
...
@Slf4j
@Aspect
@ConditionalOnProperty("luix.aop-logging.enabled")
@Configuration
@AllArgsConstructor
