...
```
docker-compose -f luix-uid-generator/luix-uid-generator-demo/src/main/docker/postgres.yml up -d
```

To stop it and remove the container, run:

```
docker-compose -f luix-uid-generator/luix-uid-generator-demo/src/main/docker/postgres.yml down
```
